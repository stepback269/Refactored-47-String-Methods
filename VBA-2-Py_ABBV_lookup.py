print(f'Copied from Idently 4/16/2025 and modified  https://www.youtube.com/watch?v=bnSYeYFRCaA&t=108s')
print(fr'Path= C:\Users\gideon\PycharmProjects\PythonProject\GG_Project-2_Strings_and-Files\.venv\VBA-2-Py_ABBV_lookup.py')
...
##     run_it = """
##     do_it= sample + '.' + method_name +'()'
##     print(do_it)
##     exec('cop=" + do_it)  #returns None but also supposedly creates the cop variable
##     """
##     exec(run_it)
##     print(cop)
