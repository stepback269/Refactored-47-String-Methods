...
print(f'Date: 10/22_E1/2025  \t\t updated Learn 47 String methods with new ideas to present See ##NEW !!!')
...
print(f'Import of func_02 as f2 is ##New !!, includes a ##New get_allowed_keystroke() function')
